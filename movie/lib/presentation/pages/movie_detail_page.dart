      ...
      body: BlocBuilder<MovieDetailBloc, MovieDetailState>(
        builder: (context, state) {
          if (state is MovieDetailLoading) {
            ...
            final MovieRecommendationState recommendationState =
                context.watch<MovieRecommendationBloc>().state;
            bool isAddedToWatchlist = context.select<MovieWatchlistBloc, bool>(
                (watchlistBloc) => (watchlistBloc.state is MovieWatchlistStatus)
                    ? (watchlistBloc.state as MovieWatchlistStatus).result
                    : false);
            return SafeArea(
              child: DetailContent(
                result,
                recommendationState is MovieRecommendationHasData
                    ? recommendationState.movie
                    : List.empty(),
                isAddedToWatchlist,
              ),
            );
                          ...
                          children: [
                              ...
                              onPressed: () {
                                ...
                                final message = context.select<
                                    ...
                                    String>((bloc) => (bloc.state
                                        is MovieWatchlistStatus)
                                    ? (bloc.state as MovieWatchlistStatus)
                                                .result ==
                                            false
                            ...
                            BlocBuilder<MovieRecommendationBloc,
                              ...
                              if (state is MovieRecommendationLoading) {
                                ...
                                return buildRecommendationCard(state.movie);
                              } else {
                                return Text("");
                              }
                            })
